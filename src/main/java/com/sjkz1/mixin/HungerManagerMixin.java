...
public abstract class HungerManagerMixin {
    ...
    public int heal2(int original) {
        int modifiedFoodTickTimer = (int) (HappinessFood.happiness <= 0 ? original + Math.abs(HappinessFood.happiness) : HappinessFood.happiness / 2);
    ...
    public int heal(int original) {
        int modifiedFoodTickTimer = (int) (HappinessFood.happiness <= 0 ? original + Math.abs(HappinessFood.happiness) : original / HappinessFood.happiness);
        return modifiedFoodTickTimer;
    }
